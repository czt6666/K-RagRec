...
def parse_args_llama():
    ...
    parser.add_argument("--num_query_tokens", type=int, default=8,
                        help="Number of soft-prompt tokens emitted by the Q-Former.")
    parser.add_argument("--qformer_num_heads", type=int, default=8)
    parser.add_argument("--qformer_dropout", type=float, default=0.0)
    parser.add_argument("--llm_hidden_dim", type=int, default=4096,
                        help="LLM hidden dim. 4096 for LLaMA-2-7B/LLaMA-3-8B, 3584 for Qwen2-7B.")
