...
def parse_args_llama():
    ...
    parser.add_argument("--seq_vocab_size", type=int, default=4000,
                        help="Item-id vocab. ML1M max id is 3952, so 4000 is safe.")
    parser.add_argument("--seq_max_len", type=int, default=32)
    parser.add_argument("--seq_d_model", type=int, default=256)
    parser.add_argument("--seq_nhead", type=int, default=4)
