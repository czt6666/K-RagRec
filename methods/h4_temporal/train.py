...
def main(args):
    ...
    with open(train_data_path, 'r') as f:
        ...
        def train(inputs, questions=None, gold=None, targets=None, sequence_ids=None):
            ...
            graph=[]
            label=[]
            seq_ids_batch=[]   # H4: raw item-id history per sample
            sample = {'id':id,'graph':graph, 'question':query, 'label':label, 'sequence_ids':seq_ids_batch}
            d = 0
            for input, question, target, sequence_id in zip(inputs, questions, targets, sequence_ids):
                ...
                seq_ids_batch.append(sequence_id)
        ...
        for epoch in range(args.num_epochs):
            ...
            epoch_log_path = f"{args.output_dir}/{args.dataset}/h4_temporal_train_log.json"
            ...
            summary_path = f"{args.output_dir}/{args.dataset}/h4_temporal_train_summary.json"
